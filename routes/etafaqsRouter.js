...
const etaFaqs = require("../models/etafaqs");
...
router.get("/:id", async (req, res) => {
  ...
  try {
    const faq = await etaFaqs.findById(id).lean();
...
router.post("/", async (req, res) => {
  ...
  try {
    const newFaq = new etaFaqs({ question, answer });
    await newFaq.save();
...
router.delete("/:id", async (req, res) => {
  ...
  try {
    const deletedFaq = await etaFaqs.findByIdAndDelete(id);
